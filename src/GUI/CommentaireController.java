...
public void initialize(Blog ev) {
        ...
        try {
            iva.setImage(Image.createImage(Storage.getInstance().createInputStream(Session.ConnectedUser.getImage_id())).scaled(100, 100));
        ...
        for (Commontaire r : lis) {
            ...
            SpanLabel t1 = new SpanLabel(r.getContent());
            ...
            Image userPicture1= UtilService.getInstance().getImageFromURL(Session.ConnectedUser.getImage_id());
