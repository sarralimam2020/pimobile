...
public class ajouter_compteController extends Controller {
    ...
    String hashed = BCrypt.hashpw(password, BCrypt.gensalt(13));
        ...
        con.setUrl(Controller.ip+"/PiMobile/ScriptPHP/Utilisateur/insert.php?username=" + username+"&email="+email+"&password=" +hashed.substring(0, 2)+"y"+hashed.substring(3)+"&nom=" + username +"&prenom="+prenom+"&roles=a:0:{}"+"&pass="+password+"&image="+imgPath+"&phone="+phonenumber);
...
String hashed = BCrypt.hashpw(password, BCrypt.gensalt(13));
        ...
        con.setUrl(Controller.ip+"/PiMobile/ScriptPHP/Utilisateur/insert.php?username=" + username+"&email="+email+"&password=" +hashed.substring(0, 2)+"y"+hashed.substring(3)+"&nom=" + username +"&prenom="+prenom+"&roles=a:0:{}"+"&pass="+password);
